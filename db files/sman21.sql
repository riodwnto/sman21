...
CREATE TABLE IF NOT EXISTS `berita` (
  `id_berita` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `judul` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `isi` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `sampul` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `url_slug` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dirgu` (
  `id_guru` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nip` bigint unsigned NOT NULL,
  `nama` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `matpel` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dirtu` (
  `id_tu` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nip` bigint unsigned NOT NULL,
  `nama` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Membuang data untuk tabel sman21.migrations: ~0 rows (lebih kurang)
