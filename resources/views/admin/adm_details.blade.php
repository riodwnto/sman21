...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data Admin /</span> Detail Admin</h4>
        ...
        <div class="col-md-12">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6 col-lg-4">
                            ...
                            <img src="{{ asset('img/account/'.Auth::user()->profil_pict) }}" alt="user-avatar"
                    ...
                    <div class="mt-2 col-lg-2 col-md-2">
                        ...
                        <a href="/admin-area/adm/edit/{{ encrypt(Auth::user()->id) }}/{{ true }}" class="btn btn-primary me-2 form-control">Edit Admin</a>
                    </div>
                </div>
                <!-- /Account -->
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="formAccountDeactivation" action="/admin-area/adm/delete/{{ Crypt::encrypt(Auth::user()->id) }}/1" method="GET" enctype="multipart/form-data">
