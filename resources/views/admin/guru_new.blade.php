                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="mb-3">
                                    <label class="form-label">NIDN Guru</label>
                                    <input type="number" name="nidn" class="form-control" placeholder="NIDN Guru" value="{{ old('nidn') }}" required>
                                    @error('nidn')
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_dosen" class="form-control" placeholder="Nama Guru" value="{{ old('nama_dosen') }}" required>
                                    @error('nama_dosen')
                                    <div id="defaultFormControlHelp" class="form-text bg-warning text-black">
                                        {{ $message }}
                                    </div>
