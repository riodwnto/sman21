...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        ...
        <form action="/admin-area/menu/insert" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="text" name="menu_nama" required />
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-md-3 col-form-label">Title</label>
                            <div class="col-md-9">
                                <input class="form-control" type="text" name="menu_title_page" required/>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-md-3 col-form-label">URL</label>
                            <div class="col-md-9">
                                <input class="form-control" type="text" name="menu_url" required/>
                            </div>
                        </div>
                        <div class="mb-3 row">
