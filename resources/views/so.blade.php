...
<head>
  ...
  <title>SMA Negeri 21 Bandung - Struktur Organisasi</title>
...
<body>
  ...
  <section id="hero" class="d-flex align-items-center" style="height: 40vh">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <h1 style="font-size: 90px">STRUKTUR ORGANISASI</h1>
  ...
  <main id="main">
    ...
    <section id="about" class="about section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-16" data-aos="fade-right" data-aos-delay="100">
